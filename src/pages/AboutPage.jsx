    ...
    <>
      <div className="article">
        <div>
          ...
          <h2 className="h2About">
            The best place to play games... and create them
          </h2>
          <div className="pAbout">
            <p>
              <span className="green-point">ø</span>Online
            </p>{" "}
            <p>
              <span className="blue-point">ø</span>Downloads
            </p>
          </div>
      ...
      <div className="article2">
        ...
        <div className="h2article">
          ...
          <p className="p2article">
            Get access to our selected games made by Ironhackers. Enjoy
            exclusive deals
          </p>
      ...
      <div className="article3">
        ...
        <div className="h2article3">
          ...
          <p className="p3article">
            Meet new gaming developers, join groups and more!
          </p>
      ...
      <div className="article4">
        ...
        <div className="h2article4">
          ...
          <p className="p4article">
            We can provide the tools and services that help game developers to
            publish their games on IronSteam
          </p>
